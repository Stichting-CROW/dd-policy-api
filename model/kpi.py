...
STANDARD_KPI_DESCRIPTIONS = [
    ...
    KPIDescription(kpi_key="percentage_parked_longer_then_24_hours", bound="upper", unit="number", title="Parkeerduur > 1 dag", description="Het percentage van voertuigen dat langer dan 24 uur geparkeerd is.", bound_description="Het maximale percentage voertuigen dat langer dan 24 uur geparkeerd mag zijn."),
