...
STANDARD_KPI_DESCRIPTIONS = [
    ...
    KPIDescription(kpi_key="percentage_non_operational_longer_then_1_day", bound="upper", unit="percentage", title="Kapot > 24 uur", description="Het percentage van voertuigen dat langer dan 24 uur kapot is.", bound_description="Het maximale percentage voertuigen dat langer dan 24 uur kapot mag zijn."),
    KPIDescription(kpi_key="percentage_non_operational_longer_then_7_days ", bound="upper", unit="percentage", title="Kapot > 7 dagen", description="Het percentage van voertuigen dat langer dan 7 dagen kapot is.", bound_description="Het maximale percentage voertuigen dat langer dan 7 dagen kapot mag zijn."),
    KPIDescription(kpi_key="minimal_number_of_available_vehicles", bound="lower", unit="number", title="Beschikbare voertuigen", description="Het minimale aantal voertuigen dat beschikbaar is.", bound_description="Het minimale aantal voertuigen dat beschikbaar moet zijn in de gemeente."),
    KPIDescription(kpi_key="usage_ratio", bound="lower", unit="number", title="Ritten per voertuig", description="Het aantal ritten per voertuig op een dag, berekend als count_trips_per_day gedeeld door count_vehicles_in_public_space.", bound_description="Het minimale aantal ritten dat per voertuig per dag gemaakt moet worden."),
]
